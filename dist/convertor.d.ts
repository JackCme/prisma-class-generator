...
export declare class PrismaConvertor {
    ...
    get config(): Partial<Record<"makeIndexFile" | "dryRun" | "separateRelationFields" | "useSwagger" | "useGraphQL" | "useUndefinedDefault" | "clientImportPath" | "useNonNullableAssertions" | "preserveDefaultNullable" | "useValidator", any>>;
    set config(value: Partial<Record<"makeIndexFile" | "dryRun" | "separateRelationFields" | "useSwagger" | "useGraphQL" | "useUndefinedDefault" | "clientImportPath" | "useNonNullableAssertions" | "preserveDefaultNullable" | "useValidator", any>>);
    ...
    extractValidatorDecoratorsFromField: (dmmfField: DMMF.Field) => DecoratorComponent[];
