    ...
    constructor() {
        ...
        this.extractSwaggerDecoratorFromField = (dmmfField) => {
            ...
            if (type === 'Prisma.JsonValue') {
                options.type = (0, util_1.capitalizeFirst)('object');
        ...
        this.extractValidatorDecoratorsFromField = (dmmfField) => {
            const decorators = [];
            ...
            if (name) {
                decorators.push(new decorator_component_1.DecoratorComponent({ name, importFrom }));
            }
            ...
            if (dmmfField.kind === 'enum') {
                name = 'IsEnum';
                decorators.push(new decorator_component_1.DecoratorComponent({ name, importFrom, params: [`${String(dmmfField.type)}`] }));
            }
            return decorators;
        };
        this.getClass = (input) => {
